...
| `locker:read` | `locker_list_documents`, `locker_search_documents`, `locker_get_document`, `locker_list_risks`, `locker_get_risk`, `locker_get_risk_stats`, `locker_get_settings`, `locker_get_usage` |
